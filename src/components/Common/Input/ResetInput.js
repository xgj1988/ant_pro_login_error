 ...
 */
export default class ResetInput extends PureComponent {
  constructor(props) {
    super(props);
    this.realItem = null;
  ...
  render() {
    const {name = '', required = false, className, maxLength = 200, size, prefixCls = 'ant-input-search', inputPrefixCls = 'ant-input', inlineMode} = this.props;
