...
export default class ProductTagTable extends PureComponent {
  render() {
    const {
    ...
    const columns = [{
      ...
      render: (val, record) => {
        ...
        return (
          ...
          >
            <PermissionAuth permissions={["system:product_tag:update", "system:product_tag:delete"]} emptyValue="无" >
              <PermissionAuth permissions="system:product_tag:update" >
                {edit}

                &nbsp;&nbsp;
              </PermissionAuth >
              <PermissionAuth permissions="system:product_tag:delete" >
                <Popconfirm
                  title="你确定要删除所选记录吗？"
                  onConfirm={() => {
    ...
    return (
      <BasicTable
        ...
        onRowDbClick={(record) => {
          ...
          if (LoginUser.hasPermissions("system:product_tag:update")) {
